...
const questions: QuestionData[] = [
  {
    ...
    content:
      'TypeScript seems to be getting so popular so I wondered whether it is worth my time learning it? What benefits does it give over JavaScript?',
    userName: 'Bob',
    created: new Date(),
    answers: [
      {
      ...
      {
        answerId: 2,
        content: 'So you can use the Javascript features of tomorrow, today',
        userName: 'Fred',
        created: new Date(),
      },
    ],
  ...
  {
    questionId: 2,
    title: 'Which state management should I use?',
    content:
